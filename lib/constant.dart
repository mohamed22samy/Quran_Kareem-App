...
Uri quranAppurl = Uri.parse("https://www.facebook.com/profile.php?id=100008159504132");
...
Future readJson ()async{
  final String response =await rootBundle.loadString("assets/font/hafs_smart_v8.json");
